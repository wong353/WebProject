				...
				<div id="join-wrapper">
					<div id="join-table">
						<table border="0">
							...
							<tr>
								<td>*휴대폰</td>
								<td colspan="2"><input type="text" name=tel1 maxlength="3" size="3" value="<%=tel1%>">-
								<input type="text" name=tel2 maxlength="4" size="4" value="<%=tel2%>">-
								<input type="text" name=tel3 maxlength="4" size="4" value="<%=tel3%>"></td>
							</tr>
							<!-- <tr>
								<td>SMS 인증번호</td>	
