			...
			<input type="hidden" name="preUrl" value=<%=preUrl%>>
				<table id="loginTable">
					...
					<tr>
						...
						<td>
							<p class="joinbtn">
								<a href="join.jsp"><span>간편 회원가입</span></a>
							</p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"><a href="">아이디 찾기</a> &nbsp |
							&nbsp <a href="">비밀번호 찾기</a></td>
					</tr>
					<tr>
						<td colspan="2"><input type="button" class="loginBtn" onclick="check_login()" value="LOGIN"></td>
					</tr>
				</table>
			</form>
		</div>
